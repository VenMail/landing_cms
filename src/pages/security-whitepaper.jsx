...
const sections = [
  ...
  { title: 'Mailbox storage', text: 'Paid managed plans currently use the same shared storage infrastructure. Nigeria, South Africa, and Europe selections record a future region preference; they do not place data in those regions today. Custom Storage uses customer-provided storage and is a separate plan. Storage placement does not by itself confine application processing, email delivery, backups, or third-party processing to the same location. Confirm the full processing scope for your deployment.' },
