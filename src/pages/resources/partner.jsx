        ...
        <div className="grid md:grid-cols-12 items-center">
          <div className="md:col-span-6">
            <div className="max-w-md">
              ...
              <a href="https://app.venmail.io/register" target="_blank" className="text-primary-600 cursor-pointer font-bold flex items-center">Sign up for free <HiArrowRight className="ml-2" /></a>
            </div>
          </div>
